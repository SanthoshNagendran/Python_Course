# this is to create a simple game in python <a snake game>
'''
i dont know what exactly the turtle module is doing in
but it could be learned later by watching into the library file
'''
...
wn = turtle.Screen()
wn.title("Snake Game by @Santhosh_Guptha 'Engineer'")
wn.bgcolor("blue")
...
# Pen
'''
this part here is to record the score that you are typing in
'''
pen = turtle.Turtle()
pen.speed(0)
pen.shape("square")
